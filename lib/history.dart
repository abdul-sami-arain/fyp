  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        child: Column(
          children: [
            Multi3(color: Colors.white, subtitle: "Your History", weight: FontWeight.normal, size: 26),
            Flexible(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    .collection('orders/${Provider11.uid}/orders')
                    .snapshots(),
                                        ...
                                        child: Container(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Multi2(color: Colors.white, subtitle: data['address'], weight: FontWeight.normal, size: 12),
                                                  Multi(color: Colors.grey, subtitle: "Rs ${data['amount']}", weight: FontWeight.bold, size: 20),
                                                ],
                                              ),
                                            ),
                                    ),
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    ...
                                                    child: Multi(color: Colors.white, subtitle: data['method'], weight: FontWeight.bold, size: 10),
                                              ),
                                              Container(
                                                height: 20.h,
                                                width: 60.w,
                                                decoration: BoxDecoration(
                                                    ...
                                                    child: Multi(color: Colors.white, subtitle: data['number'], weight: FontWeight.bold, size: 10),
                                              )
                                            ],
                                          ),
                                        )),
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  child: Multi(color: Colors.white, subtitle: data['time'], weight: FontWeight.bold, size: 10),
                                            )
                                          ],
                                        ),
                                      )),
        ...
        child: Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Multi2(color: Colors.white, subtitle: "Login to see favourities", weight: FontWeight.bold, size: 25),
