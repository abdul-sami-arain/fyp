...
class KidSection extends StatelessWidget {
  const KidSection({super.key});

  @override
  Widget build(BuildContext context) {
     final ref = FirebaseDatabase.instance.ref("kids");

    final databaseReference = FirebaseDatabase.instance.ref();
    return Scaffold(
       appBar: AppBar(
        title: Multi3(color: Colors.white, subtitle: "Kids Wearing", weight: FontWeight.normal, size: 21),
